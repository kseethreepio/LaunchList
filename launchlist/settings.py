"""
Django settings for launchlist project.
...
ROOT_URLCONF = 'launchlist.urls'

WSGI_APPLICATION = 'launchlist.wsgi.application'
...
# STATIC_ROOT = '' # Trying out http://stackoverflow.com/questions/12809416/django-static-files-404
STATIC_URL = '/static/'
